<template>
	<div class="jgb_grid-builder jgb_grid-builder-posts"
		...
		<div class="jgb_toolbar">
			<button type="button"
			        class="jgb_toolbar-remove-breakpoint-btn jgb_button"
		...
		<div class="jgb_no-items"
			...
			<button type="button"
			        class="jgb_no-items-add-btn jgb_button"
...
<script>
	...
	// main mixin
	import gridBuilderEditor from 'grid-builder/mixins/grid-builder-editor.js';
