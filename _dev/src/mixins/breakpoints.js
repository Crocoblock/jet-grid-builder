export default {
	data() {
		return {
			breakpoints: {
				desktop: Infinity,
				tablet: elementorFrontend.config.breakpoints.lg,
				mobile: elementorFrontend.config.breakpoints.md
			},
	...
	methods: {
		...
		removeLayoutBreakpoint() {
			...
			this.updateOption('layout-data' + this.getBreakpointPostfix(this.currentBreakpoint), '');
		},
